...
class DefineText extends Tag
{
    ...
    protected function getTextRecord(Parser $reader)
    {
        $flag = $reader->getUI8();
        if ($flag === 0) {
            return false;
        ...
        if ($hasColor) {
            $textRecord['TextColor'] = ($this->code == Tag::DEFINE_TEXT2) ?
